...
/***
 *
 * @param {XRequestEventName|string} name
 * @param callback
 * @returns {XRequest}
 */
...
Object.defineProperty(XResponse.prototype, 'result', {
    get: function () {
        return this._result || this.xhr.response;
    }
});
...
Object.defineProperty(XResponse.prototype, 'error', {
    get: function () {
        if (this.xhr.status === 200) return false;
        return true;
    }
});
...
Object.defineProperty(XResponse.prototype, 'headers', {
    get: function () {
        if (!this._headers) {
            var headerText = this.xhr.getAllResponseHeaders();
...
XResponse.prototype.json = function () {
    if (this.xhr.responseType === 'json') {
        this._result = this.xhr.response;
    }
    else {
        this._result = JSON.parse(this.xhr.responseText);
    }
    return this._result;
};
...
XResponse.prototype.blob = function () {
    if (this.xhr.responseType === 'blob') {
        ...
        this._result = new Blob([this.xhr.response]);
    }
    return this._result;
};
