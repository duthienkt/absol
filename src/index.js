...
import QuickIndexedArrayHolder from "./DataStructure/QuickIndexedArrayHolder";
...
var absol = (function (){
    return {
        ...
        int: int,
        array: array,
        QuickIndexedArrayHolder: QuickIndexedArrayHolder,
        safeThrow: safeThrow,
        Rectangle: Rectangle,
        ...
        BoundingObserver:BoundingObserver
    }
})();
