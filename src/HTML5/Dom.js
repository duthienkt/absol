...
var excludedKeys = ['constructor', 'super', 'eventHandler']

//full speed AbsolCore, plesase disable this for safe mode
...
excludedKeys = excludedKeys.reduce(function (obj, key) {
    obj[key] = true;
    return obj;
}, {});
/**
...
FeatureClass['AElem'+'entNS'] = {
    ...
    prototypeKeys: Object.keys(AElementNS.prototype).filter(key=> !Object.prototype.hasOwnProperty.call(Element.prototype, key) && !excludedKeys[key])
};

FeatureClass['AElem'+'ent'] = {
    constructor: AElement,
    prototypeKeys: Object.keys(AElement.prototype).filter(key=> !Object.prototype.hasOwnProperty.call(Element.prototype, key) && !excludedKeys[key])
};
